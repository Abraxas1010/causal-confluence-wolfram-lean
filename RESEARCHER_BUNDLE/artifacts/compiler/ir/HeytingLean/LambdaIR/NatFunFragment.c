...
// Module: HeytingLean.LambdaIR.NatFunFragment
// Imports: Init HeytingLean.Core.Types HeytingLean.LambdaIR.Syntax
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_HeytingLean_LambdaIR_NatFunFragment(uint8_t builtin, lean_object* w) {
lean_object * res;
