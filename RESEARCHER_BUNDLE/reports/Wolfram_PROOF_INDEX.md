# Wolfram Project — Proof Index

This file will become the stable theorem/lemma index once the Wolfram project is
fully generalized (multi-rule + multiway + branchial + bridges).

## Current key declarations

- `HeytingLean.WPP.WppRule.StepStar.trans`
- `HeytingLean.WPP.WppRule.JR.mono`
- `HeytingLean.WPP.WppRule.JR.contractive`
- `HeytingLean.WPP.WppRule.JR.idem`
- `HeytingLean.WPP.WppRule.JR.inf`
- `HeytingLean.WPP.WppRule.unreachableFrom`
- `HeytingLean.WPP.WppRule.reachabilityNucleus`

- `HeytingLean.WPP.WppRel.JR.mono`
- `HeytingLean.WPP.WppRel.JR.contractive`
- `HeytingLean.WPP.WppRel.JR.idem`
- `HeytingLean.WPP.WppRel.JR.inf`
- `HeytingLean.WPP.WppRel.unreachableFrom`
- `HeytingLean.WPP.WppRel.reachabilityNucleus`

- `HeytingLean.WPP.Wolfram.System.pathsAtDepth`
- `HeytingLean.WPP.Wolfram.System.pathCountAtDepth`
- `HeytingLean.WPP.Wolfram.System.branchialEdgesAtDepth`
...
- `HeytingLean.WPP.Wolfram.System.toWppRel_stepStar_iff`
- `HeytingLean.WPP.Wolfram.System.TerminatingFrom`
- `HeytingLean.WPP.Wolfram.Counterexamples.CE1.terminatingFrom_init`
